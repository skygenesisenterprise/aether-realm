...
# Contributing to Aether Realm

Thank you for your interest in contributing to **Aether Realm**!  
...
**Aether Realm** is the official Aether Realm of Sky Genesis Enterprise, licensed under **Apache 2.0**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/aether-realm/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/aether-realm/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve to Aether Realm! 💌
