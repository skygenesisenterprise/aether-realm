...
Thank you for using **Aether Realm** — the official Aether Realm developed and maintained by [Sky Genesis Enterprise](https://skygenesisenterprise.com).
...
If you're using the open-source version of Aether Realm and need help with:
...
- 💬 [GitHub Discussions](https://github.com/skygenesisenterprise/aether-realm/discussions)
- 🐞 [GitHub Issues](https://github.com/skygenesisenterprise/aether-realm/issues) – for bug reports only
...
If you are using Aether Realm in a professional or production environment and require:
...
Want to help improve for the Aether Realm?  
